...
class GenreFeatureData:
    ...
    training_folder = "../input/gtzan/_train"
    val_folder = "../input/gtzan/_validation"
    test_folder = "../input/gtzan/_test"
    dir_all_files = "../input/gtzan"

    train_X_preprocessed_data = "../input/gtzan/data_train_input.npy"
    train_Y_preprocessed_data = "../input/gtzan/data_train_target.npy"
    dev_X_preprocessed_data = "../input/gtzan/data_validation_input.npy"
    dev_Y_preprocessed_data = "../input/gtzan/data_validation_target.npy"
    test_X_preprocessed_data = "../input/gtzan/data_test_input.npy"
    test_Y_preprocessed_data = "../input/gtzan/data_test_target.npy"
    ...
    def __init__(self):
        ...
        self.trainfiles_list = self.path_to_audiofiles(self.training_folder)
